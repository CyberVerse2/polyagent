...
const Sidebar = forwardRef<{ refreshBalances: () => void }, {}>(function Sidebar(props, ref) {
  ...
  const isWalletEffectivelyConnected = Boolean(
    isAppKitConnected || (ready && authenticated && !!connectedWallet)
  );
        ...
        <div className="flex items-center gap-3 mb-2">
          ...
          <div className="flex-1">
            <div className="flex items-center gap-2">
              ...
              {ready && <ConnectionIndicator connected={isWalletEffectivelyConnected} />}
            </div>
            {displayAddress && (
